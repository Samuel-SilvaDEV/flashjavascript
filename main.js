const weatherAPIKey = "dd48955fda0143a07b292cd8dcaac39b";
...
function populateProducts(productList) {
       ...
       // Run a loop through the products and creat an HTML element for each of them
       productList.forEach(function(product, index){

        // Create the HTML element for the indivudual product    
        ...
        // Add complete individual product tp the product section   
